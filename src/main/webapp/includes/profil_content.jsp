<div class="row">
	<div class="col-lg-4 col-md-5">
		<div class="card card-user">
			...
			<div class="content">
				<div class="author">
					<img class="avatar border-white" src="<s:property value='#session.path'/>"
						alt="..." />
					<h4 class="title">
						<s:property value='nom'/> <s:property value='prenom'/> <br/>
					</h4>
				</div>
			</div>
			...
			<div class="text-center">			
				<div class="row">
					<div class="col-md-3 col-md-offset-1">
						<h5><s:property value='reservations'/> <br />
							<small class="label label-primary">En cours</small>
						</h5>
					</div>
					<div class="col-md-4">
						<h5>
							<s:property value='retard'/><br />
							<span class="label label-warning">Retard</span>
						</h5>
					</div>
					<div class="col-md-3">
						<h5>
							<s:property value='history'/><br />
							<small class="label label-success">Archives</small>
						</h5>
					</div>
				</div>
			</div>
			...
			<div class="content">
				<form action="updateProfil" method="POST">
						...
						<div class="col-md-3	">
							<div class="form-group">
								<label>Nom</label> <input type="text"
									class="form-control border-input" placeholder="Dupond" name="nom"
									value="<s:property value='nom'/>">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label>Prénom</label> <input type="text"
									class="form-control border-input" placeholder="David" name="prenom"
									value="<s:property value='prenom'/>">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
						...
						<div class="col-md-4">
							<div class="form-group">
								<label>Date de naissance</label> <input type="text"
									...
									placeholder="date de naissance" value="<s:property value='naissance'/>">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
						...
						<div class="col-md-4">
							<div class="form-group">
								<label>Fin abonnement</label> <input type="text"
									class="form-control border-input" disabled name="finAbonnement"
									placeholder="Last Name" value="<s:property value='finAbonnement'/>">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-7">
							<div class="form-group">
								<label>Photo</label> <input type="file" class="form-control-file"
									id="exampleInputFile" aria-describedby="fileHelp" name="photo"> <small
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								<input type="password"  class="form-control border-input" value="<s:property value='password'/>" name="password" placeholder="mot de passe">
							</div>
						</div>
					</div>
